		...
		if (savedProducts) {
			try {
				...
				const totals = data.reduce(
					(
						sum: { totalRevenue: number; currentStock: number },
						obj: Product,
					) => ({
	...
	return (
		...
		>
			...
			>
				...
				>
					<InfoOutlinedIcon
						sx={{ color: "#22c55e", fontSize: 18, mt: "2px", flexShrink: 0 }}
					/>
					<Box>
						<Typography
							sx={{
						...
						>
							Your food security score reflects how well you manage inventory to
							prevent waste while maintaining supply. This affects community
							food stability, helps control inflation, and ensures long-term
